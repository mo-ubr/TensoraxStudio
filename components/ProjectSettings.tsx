...
const API_SLOTS: ApiSlot[] = [
  {
    ...
    models: [
      { group: 'Google Gemini', items: ['gemini-3.1-pro-preview', 'gemini-3.0-pro', 'gemini-2.5-pro'] },
      { group: 'Google Gemini — Fast', items: ['gemini-3-flash-preview', 'gemini-3.1-flash-lite', 'gemini-2.5-flash'] },
      { group: 'Anthropic Claude', items: ['claude-opus-4-6', 'claude-sonnet-4-6', 'claude-haiku-4-5'] },
      { group: 'OpenAI', items: ['gpt-5.4', 'gpt-4.1', 'gpt-5.4-mini'] },
      { group: 'Qwen — Flagship', items: ['qwen/qwen3-235b-a22b'] },
      { group: 'Qwen — Vision', items: ['qwen/qwen3-vl-235b-a22b', 'qwen/qwen3-vl-plus', 'qwen/qwen2.5-vl-32b', 'qwen/qwen2.5-omni-7b', 'qwen-vl-max'] },
      { group: 'Qwen — Text', items: ['qwen/qwen3-32b', 'qwen/qwen3-30b-a3b', 'qwen/qwen3-14b'] },
      { group: 'Qwen — OCR/Doc', items: ['qwen-ocr'] },
      { group: 'Meta Llama', items: ['meta-llama/llama-4-maverick', 'meta-llama/llama-4-scout'] },
      { group: 'Mistral', items: ['mistral-large-2512', 'pixtral-large-2411', 'mistral-small-latest'] },
  ...
  },
  {
    ...
    models: [
      { group: 'Google Gemini', items: ['gemini-3.1-pro-preview', 'gemini-3.0-pro', 'gemini-2.5-pro'] },
      { group: 'Google Gemini — Fast', items: ['gemini-3-flash-preview', 'gemini-2.5-flash'] },
      { group: 'OpenAI', items: ['gpt-5.4', 'gpt-4.1'] },
      { group: 'Qwen — Vision/Omni', items: ['qwen/qwen3-vl-235b-a22b', 'qwen/qwen3-vl-plus', 'qwen/qwen2.5-vl-32b', 'qwen/qwen2.5-omni-7b', 'qwen-vl-max'] },
      { group: 'Meta Llama', items: ['meta-llama/llama-4-maverick', 'meta-llama/llama-4-scout'] },
    ],
  },
  {
    ...
    models: [
      { group: 'Anthropic Claude', items: ['claude-opus-4-6', 'claude-sonnet-4-6'] },
      { group: 'Google Gemini', items: ['gemini-3.1-pro-preview', 'gemini-3.0-pro'] },
      { group: 'OpenAI', items: ['gpt-5.4', 'gpt-4.1'] },
      { group: 'Qwen — Flagship', items: ['qwen/qwen3-235b-a22b'] },
      { group: 'Qwen — Text', items: ['qwen/qwen3.5-plus', 'qwen/qwen3-32b', 'qwen/qwen3-30b-a3b'] },
      { group: 'Qwen — Translation', items: ['qwen-mt-turbo'] },
      { group: 'Meta Llama', items: ['meta-llama/llama-4-maverick'] },
      { group: 'Mistral', items: ['mistral-large-2512'] },
      { group: 'DeepSeek', items: ['deepseek-chat'] },
    ],
  },
  {
    ...
    models: [
      ...
      { group: 'Other Google', items: ['gemini-3-pro-image-preview', 'gemini-2.0-flash-exp'] },
      { group: 'Qwen Image (DashScope)', items: ['qwen-image-plus', 'qwen-image-edit'] },
    ],
  },
  {
    id: 'video-gen',
