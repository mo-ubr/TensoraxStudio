...
const API_SLOTS: ApiSlot[] = [
  {
    ...
    models: [
      ...
      { group: 'Qwen — Flagship', items: ['qwen3-235b-a22b'] },
      { group: 'Qwen — Vision', items: ['qwen-vl-max', 'qwen2.5-vl-32b-instruct', 'qwen2.5-omni-7b'] },
      { group: 'Qwen — Text', items: ['qwen3-32b', 'qwen3-30b-a3b', 'qwen3-14b'] },
  ...
  },
  {
    ...
    models: [
      ...
      { group: 'Qwen — Vision/Omni', items: ['qwen-vl-max', 'qwen2.5-vl-32b-instruct', 'qwen2.5-omni-7b'] },
      { group: 'Meta Llama', items: ['meta-llama/llama-4-maverick', 'meta-llama/llama-4-scout'] },
    ],
  },
  {
    ...
    models: [
      ...
      { group: 'OpenAI', items: ['gpt-5.4', 'gpt-4.1'] },
      { group: 'Qwen — Flagship', items: ['qwen3-235b-a22b'] },
      { group: 'Qwen — Text', items: ['qwen3-32b', 'qwen3-30b-a3b'] },
  ...
  },
  {
    ...
    models: [
      ...
      { group: 'Qwen Image (DashScope)', items: ['qwen-image-plus', 'qwen-image-edit-plus'] },
    ],
  },
  {
    id: 'video-gen',
