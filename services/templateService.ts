...
export const TEAM_CATALOGUE: TeamMeta[] = [
  ...
  },
  {
    ...
    description: 'Core creative engine — produces raw assets from briefs and research',
    icon: 'fa-film',
    agents: [
      { id: 'creative-director', name: 'Creative Director', team: 'production', description: 'Team lead — receives research and brief, orchestrates creative work', icon: 'fa-wand-magic-sparkles' },
      { id: 'concept-creation', name: 'Concept Creation', team: 'production', description: 'Generates creative concepts, campaign angles, content strategies', icon: 'fa-lightbulb' },
      { id: 'screenplay', name: 'Screenplay', team: 'production', description: 'Writes structured screenplays with scene breakdowns', icon: 'fa-scroll' },
      { id: 'copywriter', name: 'Copywriter', team: 'production', description: 'Blog posts, ad copy, social captions, product descriptions, scripts', icon: 'fa-pen-fancy' },
      { id: 'tagline', name: 'Tagline Generator', team: 'production', description: 'Creates brand taglines and slogans', icon: 'fa-quote-right' },
      { id: 'social-copy', name: 'Social Copy', team: 'production', description: 'Platform-specific social media copy with hashtags and CTAs', icon: 'fa-share-nodes' },
      { id: 'image-producer', name: 'Image Producer', team: 'production', description: 'Keyframes, product shots, lifestyle imagery, thumbnails', icon: 'fa-image' },
      { id: 'character-builder', name: 'Character Builder', team: 'production', description: 'Visual SVG-based character trait composer', icon: 'fa-person' },
      { id: 'character-frames', name: 'Character Frames', team: 'production', description: 'Character scene frames and poses', icon: 'fa-people-group' },
      { id: 'character-variations', name: 'Character Variations', team: 'production', description: 'Wardrobe, aging, expression variations', icon: 'fa-shirt' },
      { id: 'video-producer', name: 'Video Producer', team: 'production', description: 'Video clips from keyframes, lip sync, multi-person scenes', icon: 'fa-video' },
      { id: 'video-from-keyframes', name: 'Video from Keyframes', team: 'production', description: 'Generate video segments between consecutive keyframe images', icon: 'fa-clapperboard' },
      { id: 'video-from-prompt', name: 'Video from Prompt', team: 'production', description: 'Generate video from text prompt only', icon: 'fa-spell-check' },
      { id: 'video-from-start-image', name: 'Video from Start Image', team: 'production', description: 'Generate video starting from a single image', icon: 'fa-play' },
